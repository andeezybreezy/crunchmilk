(function() {
  ...
  function calculate() {
    var w=f('weight')*0.453592;var met=f('activity');var min=f('minutes');var cal=met*w*3.5/200*min;var _r = {burned:fmt(cal,0)+' cal',perHour:fmt(cal/min*60,0)+' cal/hr',fatLbs:fmt(cal/3500, 2)+' lbs'};
