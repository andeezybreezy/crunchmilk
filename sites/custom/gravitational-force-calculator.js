(function() {
  ...
  function calculate() {
    ...
    // Calculation logic
    var G = 6.674e-11; var force = G * mass1 * mass2 / (distance * distance); var accel = force / mass2;     document.getElementById('force').textContent = fmt(force, 2);
    document.getElementById('accel').textContent = fmt(accel, 2);
