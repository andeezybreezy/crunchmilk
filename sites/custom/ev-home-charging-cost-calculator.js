(function() {
  ...
  function calculate() {
    ...
    var currentCharge = parseFloat(document.getElementById('currentCharge').value) || 0;
    var targetCharge = parseFloat(document.getElementById('targetCharge').value) || 0;
  ...
  ['batteryKwh', 'currentCharge', 'targetCharge', 'electricRate'].forEach(function(id) {
