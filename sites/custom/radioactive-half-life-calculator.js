(function() {
  ...
  function calculate() {
    ...
    // Calculation logic
    var halvings = elapsed / halfLife; var remaining = initial * Math.pow(0.5, halvings); var decayed = initial - remaining;     document.getElementById('remaining').textContent = fmt(remaining, 2);
    document.getElementById('decayed').textContent = fmt(decayed, 2);
