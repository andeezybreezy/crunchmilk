(function() {
  ...
  function calculate() {
    ...
    // Calculation logic
    var contentPct = (domesticValue / totalValue) * 100; var thresholds = {'USMCA (75% auto, 60% other)': 60, 'EU FTA (varies)': 55, 'CAFTA-DR (35%)': 35, 'General (50%)': 50}; var threshold = thresholds[agreement] || 50; var qualifies = contentPct >= threshold ? 'Yes - qualifies for preferential rate' : 'No - does not meet content threshold'; return {contentPct: fmt(contentPct,1), threshold: fmt(threshold,0), qualifies: qualifies};
