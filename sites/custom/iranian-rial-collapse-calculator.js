(function() {
  ...
  function calculate() {
    ...
    // Calculation logic
    var rates = {jcpoa: {official: 32000, black: 38000, inflation: 12}, moderate: {official: 42000, black: 180000, inflation: 30}, strict: {official: 42000, black: 350000, inflation: 45}, max: {official: 42000, black: 550000, inflation: 55}}; var r = rates[v.sanctionLevel]; var salaryRial = v.salary * 1e6; var salaryUSDblack = salaryRial / r.black; var preJCPOArate = 32000; var powerLoss = ((r.black - preJCPOArate) / r.black * 100);     document.getElementById('officialRate').textContent = '1 USD = ' + r.official.toLocaleString() + ' rial (gov)';
