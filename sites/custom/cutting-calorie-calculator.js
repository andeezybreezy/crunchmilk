(function() {
  ...
  function calculate() {
    var w=f('weight')*0.453592;var h=f('height')*2.54;var age=f('age');var bmr=10*w+6.25*h-5*age+5;var factors=[1.2,1.375,1.55,1.725,1.9];var maintain=bmr*factors[Math.min(f('activity')-1,4)];var deficit=500;var cut=maintain-deficit;var protein=f('weight')*1.2;var _r = {maintain:fmt(maintain,0)+' cal',cut:fmt(cut,0)+' cal',protein:fmt(protein,0)+'g',deficit:fmt(deficit,0)+' cal'};
