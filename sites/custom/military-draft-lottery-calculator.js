(function() {
  ...
  function calculate() {
    ...
    document.getElementById('ageRisk').textContent = v.age <= 20 ? 'Highest risk — called first' : v.age <= 25 ? 'High risk — primary pool' : v.age <= 30 ? 'Moderate risk — secondary pool' : 'Lower risk — called last';
