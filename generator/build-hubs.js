...
const CATEGORY_META = {
  ...
  'currency': { name: 'Currency Conversion Calculators', slug: 'currency-calculators', color: '#059669', colorDark: '#047857', tagline: 'Convert between world currencies and calculate forex trades', intro: '<p>Quick currency conversion calculators for travelers, traders, and businesses. Convert USD to JPY, EUR, GBP, and more. Calculate forex pip values and lot sizes.</p>' },
  'precious-metals': { name: 'Gold & Precious Metal Calculators', slug: 'precious-metals-calculators', color: '#d97706', colorDark: '#b45309', tagline: 'Calculate gold, silver, and platinum values', intro: '<p>Precious metal calculators for investors and collectors. Calculate melt values, karat purity, investment returns, and scrap gold prices.</p>' },
  'ai-developer': { name: 'AI & Developer Cost Calculators', slug: 'ai-developer-calculators', color: '#6366f1', colorDark: '#4f46e5', tagline: 'Calculate API costs, token usage, and AI development expenses', intro: '<p>Essential calculators for AI developers and teams. Estimate Claude API costs, compare LLM pricing, calculate token usage, and plan AI infrastructure budgets.</p>' },
  'economics': { name: 'Economics & Dollar Calculators', slug: 'economics-calculators', color: '#dc2626', colorDark: '#b91c1c', tagline: 'Analyze economic trends, purchasing power, and currency risks', intro: '<p>Economic analysis calculators for understanding macro trends. Model dollar devaluation scenarios, calculate purchasing power erosion, and analyze national debt impacts.</p>' },
  'blockchain': { name: 'Blockchain & DeFi Calculators', slug: 'blockchain-calculators', color: '#f59e0b', colorDark: '#d97706', tagline: 'Calculate DeFi yields, gas fees, and blockchain economics', intro: '<p>Specialized blockchain calculators for DeFi investors and crypto enthusiasts. Calculate XRP profits, Ethereum gas fees, staking rewards, and impermanent loss.</p>' },
  'food-beverage': { name: 'Food & Beverage Calculators', slug: 'food-beverage-calculators', color: '#dc2626', colorDark: '#b91c1c', tagline: 'Brewing, cocktails, coffee, and specialty food calculations', intro: '<p>Calculators for home brewers, baristas, and cocktail enthusiasts. Calculate ABV, coffee brew ratios, sourdough hydration, and more.</p>' },
  'music': { name: 'Music & Production Calculators', slug: 'music-calculators', color: '#7c3aed', colorDark: '#6d28d9', tagline: 'BPM, delay times, and music theory calculations', intro: '<p>Essential calculators for musicians and producers. Calculate tempo, delay times, reverb settings, and key transpositions.</p>' },
  'diy-home': { name: 'DIY & Home Improvement Calculators', slug: 'diy-home-calculators', color: '#ea580c', colorDark: '#c2410c', tagline: 'Calculate materials for home improvement projects', intro: '<p>Home improvement calculators for DIY enthusiasts. Estimate paint, tile, wallpaper, decking, and insulation needs before you start your project.</p>' },
  'travel': { name: 'Travel Calculators', slug: 'travel-calculators', color: '#0891b2', colorDark: '#0e7490', tagline: 'Plan trips, compare costs, and budget your travels', intro: '<p>Travel planning calculators for smart travelers. Budget your trip, compare hotel costs, calculate jet lag recovery, and convert time zones.</p>' },
  'gaming': { name: 'Gaming Calculators', slug: 'gaming-calculators', color: '#6366f1', colorDark: '#4f46e5', tagline: 'DPS, loot odds, and gaming performance calculations', intro: '<p>Gaming calculators for PC gamers and streamers. Calculate DPS, loot drop probabilities, FPS benchmarks, and streaming earnings.</p>' },
  'electrical': { name: 'Electrical Calculators', slug: 'electrical-calculators', color: '#eab308', colorDark: '#ca8a04', tagline: 'Wire sizing, voltage drop, and electrical load calculations', intro: '<p>Electrical calculators for electricians, engineers, and DIYers. Size wires, calculate voltage drop, determine breaker sizes, and plan electrical panels.</p>' },
  'plumbing': { name: 'Plumbing Calculators', slug: 'plumbing-calculators', color: '#0369a1', colorDark: '#075985', tagline: 'Pipe sizing, water flow, and plumbing system calculations', intro: '<p>Plumbing calculators for professionals and homeowners. Size pipes, calculate water flow rates, determine water heater capacity, and plan irrigation systems.</p>' },
  'geopolitical-energy': { name: 'Geopolitical & Energy Calculators', slug: 'geopolitical-energy-calculators', color: '#991b1b', colorDark: '#7f1d1d', tagline: 'Oil prices, sanctions impact, conflict risk, and energy security calculations', intro: '<p>Geopolitical and energy calculators for understanding how global conflicts, sanctions, and supply disruptions affect oil prices, gas costs, and your household budget. Model scenarios from Strait of Hormuz closures to OPEC production cuts and see the personal financial impact.</p>' },
  'mental-health': { name: 'Mental Health Calculators', slug: 'mental-health-calculators', color: '#8b5cf6', colorDark: '#7c3aed', tagline: 'Anxiety, stress, sleep, and mental wellness assessments', intro: '<p>Mental health calculators for self-assessment and awareness. Screen for anxiety, depression, stress levels, and sleep quality. These tools are for informational purposes only and are not a substitute for professional diagnosis.</p>' },
  'pregnancy': { name: 'Pregnancy & Baby Calculators', slug: 'pregnancy-calculators', color: '#ec4899', colorDark: '#db2777', tagline: 'Due dates, growth tracking, and baby planning calculations', intro: '<p>Pregnancy and baby calculators for expecting and new parents. Estimate due dates, track fetal growth, calculate formula needs, and plan for baby expenses.</p>' },
  'insurance': { name: 'Insurance Calculators', slug: 'insurance-calculators', color: '#2563eb', colorDark: '#1d4ed8', tagline: 'Coverage needs, deductibles, and premium comparison calculators', intro: '<p>Insurance calculators to help you understand coverage needs, compare deductible options, estimate premiums, and make informed decisions about auto, home, health, and life insurance.</p>' },
  'middle-school-math': { name: 'Middle School Math Calculators', slug: 'middle-school-math-calculators', color: '#2563eb', colorDark: '#1d4ed8', tagline: 'Fractions, percents, ratios, geometry, and more for grades 6-8', intro: '<p>Free math calculators built for middle school students. Get instant answers with step-by-step breakdowns for fractions, percentages, ratios, area, volume, and basic algebra. Every calculator shows the formula so you actually learn the math behind the answer.</p>' },
  'high-school-math': { name: 'High School Math Calculators', slug: 'high-school-math-calculators', color: '#7c3aed', colorDark: '#6d28d9', tagline: 'Algebra, geometry, trigonometry, and pre-calculus solvers', intro: '<p>Free math calculators for algebra, geometry, trigonometry, and pre-calculus. Solve quadratic equations, graph linear functions, factor polynomials, evaluate trig functions, and more. Each tool shows the formulas and steps so you build real understanding, not just get answers.</p>' }
};
